  ...
  return (
    <section id="hero" className="relative h-screen w-full overflow-hidden transition-colors duration-300">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
        <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} className="text-5xl md:text-6xl font-bold mb-4">
          Bem-vindo à Fedumenti Group
        </motion.h1>
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.5 }} className="text-lg md:text-xl max-w-2xl">
